...
from apps.galeria.views import \
     index, imagem, buscar, nova_imagem, editar_imagem, deletar_imagem, filtro_categoria
...
urlpatterns = [
    ...
    path('filtro_categoria/<str:categoria>', filtro_categoria, name='filtro_categoria'),
]